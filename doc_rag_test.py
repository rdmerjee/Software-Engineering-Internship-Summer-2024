...
'''
# Test query
test_query = "What is the cord length of the headphone cable for the Sony XM4 headphones?"
...
# User query calls an input function which uses the RAG to generate an answeri
# GOOD
